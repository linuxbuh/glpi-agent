...
SetupLocation = "https://github.com/linuxbuh/glpi-agent/releases/download/" & SetupVersion
...
'
SetupOptions = "/quiet RUNNOW=1 NO_SSL_CHECK=1 SERVER='https://glpi.ztime.ru/front/inventory.php'"
